<aside class="hidden md:flex w-64 flex-col bg-body border-r border-theme">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('admin.services.index') }}" class="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition {{ request()->routeIs('admin.services.*') ? 'bg-white/5 text-primary' : 'text-muted hover:text-primary hover:bg-white/5' }}">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">

        ...
        <div class="grid grid-cols-1 gap-12 md:grid-cols-4">
            ...
            <div>
                ...
                <div class="mt-6 flex space-x-4">
                    <a href="{{ \App\Models\Setting::get('social_facebook', '#') }}" class="text-muted-light hover:text-[#305CDE] transition" aria-label="Facebook" rel="noopener noreferrer">
                    ...
                    <a href="{{ \App\Models\Setting::get('social_twitter', '#') }}" class="text-muted-light hover:text-[#305CDE] transition" aria-label="Twitter" rel="noopener noreferrer">
                    ...
                    <a href="{{ \App\Models\Setting::get('social_linkedin', '#') }}" class="text-muted-light hover:text-[#305CDE] transition" aria-label="LinkedIn" rel="noopener noreferrer">

...
<section class="relative overflow-hidden bg-body pt-16 pb-20 lg:pt-24 lg:pb-28">
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
        ...
        <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('contact') }}" class="btn-gradient">Plan Your Web App</a>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
            ...
            <h2 class="text-3xl lg:text-4xl font-bold text-primary mt-4" style="font-family: 'Space Grotesk', sans-serif;">
                Tools Designed Around Your Workflow
            </h2>
            <p class="mt-4 text-muted">
                From internal dashboards to customer portals, we build applications that solve real problems and grow with your business.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="0">
                ...
                <h3 class="text-lg font-semibold text-primary mb-2">Custom Dashboards</h3>
                <p class="text-sm text-muted">Clear, visual dashboards that give you real-time insight into sales, operations, users, or anything that matters.</p>
            </div>
            ...
            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-lg font-semibold text-primary mb-2">Secure User Access</h3>
                <p class="text-sm text-muted">Role-based logins, permissions, and authentication so the right people access the right data.</p>
            </div>
            ...
            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3 class="text-lg font-semibold text-primary mb-2">Workflow Automation</h3>
                <p class="text-sm text-muted">Reduce repetitive work with automated approvals, notifications, reports, and data syncing.</p>
            </div>

            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="300">
                <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#305CDE] to-[#00B6DA] mb-4">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>
                </div>
                <h3 class="text-lg font-semibold text-primary mb-2">Payment & Billing</h3>
                <p class="text-sm text-muted">Integrate invoices, subscriptions, and online payments directly into your application.</p>
            </div>

            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="400">
                <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#305CDE] to-[#00B6DA] mb-4">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                </div>
                <h3 class="text-lg font-semibold text-primary mb-2">API & Integrations</h3>
                <p class="text-sm text-muted">Connect your app with third-party tools, payment gateways, CRMs, and external APIs.</p>
            </div>

            <div class="glass-card-hover p-6 rounded-2xl border border-white/10" data-aos="fade-up" data-aos-delay="500">
                <div class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-[#305CDE] to-[#00B6DA] mb-4">
                    <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                </div>
                <h3 class="text-lg font-semibold text-primary mb-2">Scalable Architecture</h3>
                <p class="text-sm text-muted">Built to handle more users, more data, and more features as your business expands.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div data-aos="fade-left">
                <img src="{{ asset('images/services/web-application-wesolve.webp') }}" alt="Custom web application dashboard tailored to a business workflow" class="w-full rounded-2xl shadow-lg border border-white/10" loading="lazy" width="1200" height="800" decoding="async">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div data-aos="fade-right" class="order-2 lg:order-1">
                <img src="{{ asset('images/services/app-development-wesolve.webp') }}" alt="Scalable web application architecture supporting growing user traffic" class="w-full rounded-2xl shadow-lg border border-white/10" loading="lazy" width="1200" height="800" decoding="async">
            </div>
...
<section class="py-24 lg:py-32 bg-body relative">
    ...
    <div class="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center" data-aos="zoom-in">
        <span class="tag mb-4">Let's Build It</span>
        <h2 class="text-3xl lg:text-5xl font-bold text-primary mt-4 mb-6" style="font-family: 'Space Grotesk', sans-serif;">
            Have a Process We Can Automate?
        </h2>
        <p class="text-muted mb-10 max-w-2xl mx-auto">
            Tell us what slows your team down. We will map out a web application that saves hours every week and keeps your data organized.
        </p>
        <a href="{{ route('contact') }}" class="btn-gradient text-lg py-4 px-10">Start the Conversation</a>
    </div>
</section>
@endsection
